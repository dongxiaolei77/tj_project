...
select '${v_sdate}'             as day_id,
       ...
       null                     as remark
from (
         select guar_id     as guar_id,
                cust_name   as cust_name,
                cust_class  as cust_type,
                loan_bank   as full_bank,
                guar_class  as gnd_indus_class,
     ...
     (
         select t1.project_id,
                sum(t2.shou_comp_amt) as recovery_amt
