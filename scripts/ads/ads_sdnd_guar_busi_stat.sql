...
-- 开发人   : zhangfl
-- 开发时间 ：20230820
-- 目标表   ：ads_sdnd_guar_busi_stat
-- 源表     ：da_base.dwd_sdnd_data_report_guar_tag
--            
--            
-- 备注     ：国担上报-山东农担业务发展情况统计，基于国担上报数据底表数据开发
-- 变更记录 ：

-- ---------------------------------------

delete from dw_base.ads_sdnd_guar_busi_stat where day_id = '${v_sdate}';
commit;
insert into dw_base.ads_sdnd_guar_busi_stat
( day_id                -- 数据日期
