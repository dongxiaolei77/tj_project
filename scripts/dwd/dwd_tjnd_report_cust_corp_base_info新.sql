...
from (
         ...
         from (
                  select t1.cert_no                                                                       -- 企业证件号码
                       ...
                       , case
                             when (t1.cust_type = '法人或其他组织' or
                                   (t1.cust_class is null and left(t1.cert_no, 1) = '9')) and
                                  t1.cust_class regexp '家庭农场' then '02'
                             when (t1.cust_type = '法人或其他组织' or
                                   (t1.cust_class is null and left(t1.cert_no, 1) = '9')) and
                                  t1.cust_class regexp '合作社|联合社|联合总社' then '04'
                             when (t1.cust_type = '法人或其他组织' or (t1.cust_class is null and left(t1.cert_no, 1) = '9'))
                                 then '03'
                             else t1.cust_type
